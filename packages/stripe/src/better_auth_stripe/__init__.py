"""better-auth Stripe billing + webhooks plugin.
...
from better_auth_stripe.client import StripeAPIError, StripeClient
from better_auth_stripe.plugin import STRIPE_ERROR_CODES, stripe
