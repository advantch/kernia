...
Returns a `KerniaPlugin` value that contributes the SSO endpoints, schema,
...
Configuration lives under `KerniaOptions.advanced["sso"]`:
...
from kernia_sso import routes as _routes
from kernia_sso.domain import provider_for_email
from kernia_sso.errors import SSO_ERROR_CODES
from kernia_sso.schema import SSO_MODELS
