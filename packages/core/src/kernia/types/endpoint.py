...
`kernia.api.endpoint.create_auth_endpoint`. The router composes these into the
public auth surface.
"""
...
from kernia.types.context import EndpointContext  # noqa: E402
