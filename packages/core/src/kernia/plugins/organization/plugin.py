...
:class:`KerniaPlugin` bundling the schema, endpoints, hooks, and error codes
...
from kernia.plugins.organization import hooks as _hooks
from kernia.plugins.organization import routes as _routes
from kernia.plugins.organization import schema as _schema
