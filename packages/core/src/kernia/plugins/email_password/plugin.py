...
focused on registration. Plugin shape mirrors `KerniaPlugin`.
"""
...
from kernia.plugins.email_password import routes
...
def email_and_password() -> KerniaPlugin:
    """Construct the email/password plugin.

    The plugin is enabled by the top-level `KerniaOptions.email_and_password`
