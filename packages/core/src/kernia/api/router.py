...
from kernia.api.request import (
    ASGIRequest,
    HTMLResponse,
    JSONResponse,
    RedirectResponse,
...
async def _handle_http(
    ...
    try:
        ...
        # Resolve the Better Auth-compatible session cookie before route handlers.
        ...
        from kernia.auth.rate_limit import enforce_rate_limit
