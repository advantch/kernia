...
convention. Every plugin contributes its own codes via `BetterAuthPlugin.error_codes`.
"""
...
# Core error codes — plugins extend this via `BetterAuthPlugin.error_codes`.
