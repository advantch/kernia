...
`better_auth.oauth2` so they're shared with the generic OAuth plugin.
"""
...
class _GoogleProvider:
    ...
    async def validate_token(
        ...
        *,
        ...
        from better_auth.oauth2 import exchange_code
    ...
    async def user_profile(
        ...
        *,
        ...
        from better_auth.oauth2 import fetch_userinfo, verify_id_token
