...
Session tests should prove that sign-in sets cookies, `/get-session` reads them, revocation removes server state, and a revoked cookie no longer authenticates.
