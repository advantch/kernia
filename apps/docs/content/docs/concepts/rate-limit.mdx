...
Rate-limit tests should hit the public route repeatedly through the mounted framework app. That proves middleware order, path matching, identity extraction, and error serialization.
