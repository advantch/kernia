...
Test that expected routes appear, disabled plugins do not appear, request body schemas are emitted, Scalar loads, and the document validates as OpenAPI 3.1.
