...
Use an injected HTTP transport to test safe passwords, compromised passwords, provider failure, cache hits, custom paths, disabled mode, and the `PASSWORD_COMPROMISED` error payload.
