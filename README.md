...
| stripe | 118 | 157 | 75 % — metered/upgrade/customer/webhook + checkout hook + schedule + auto-managed seats + org member-change seat-sync + seat-swap upgrades + trial-abuse prevention + trial-data propagation + cancel/schedule webhook lifecycle + org customer creation/reuse/billing-portal |
