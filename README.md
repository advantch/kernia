...
| username | 21 | 37 | 57 % |
| api_key | 102 | 178 | 57 % — multi-config, scopes, org-owned, legacy metadata migration, deferUpdates via backgroundTasks |
