...
| stripe | 103 | 157 | 66 % — metered/upgrade/customer/webhook + checkout hook + schedule + auto-managed seats + org member-change seat-sync + seat-swap upgrades + trial-abuse prevention + trial-data propagation |
