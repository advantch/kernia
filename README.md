...
| stripe | 99 | 157 | 63 % — metered/upgrade/customer/webhook + checkout hook + schedule + auto-managed seats + org member-change seat-sync + seat-swap upgrades |
